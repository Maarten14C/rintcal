...
errors <- .05*dates
depths <- 4:0
draw.dates(dates, errors, depths, BCAD=TRUE, add=FALSE)
```

or add them to an existing plot:

```{R, fig.width=4, fig.asp=1}
plot(0, type="n", xlim=c(1000, 1850), ylim=c(0,5), xlab="AD", ylab="dates")
draw.dates(dates, errors, depths, BCAD=TRUE, add=TRUE)
```
