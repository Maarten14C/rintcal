...
set.seed(123)
dates <- sort(sample(1000:2000,5))
errors <- .05*dates
depths <- 1:length(dates)
my.labels <- c("my", "very", "own", "simulated", "dates")
draw.dates(dates, errors, depths, BCAD=TRUE, labels=my.labels, age.lim=c(100, 2020))
```
...
draw.dates(dates, errors, depths, BCAD=TRUE, add=TRUE, labels=my.labels)
```
